function SortableTable (tableEl) {
	...
	this.tbody = tableEl.getChildNodesByTagName('tbody');
	this.thead = tableEl.getChildNodesByTagName('thead');
	this.tfoot = tableEl.getChildNodesByTagName('tfoot');
